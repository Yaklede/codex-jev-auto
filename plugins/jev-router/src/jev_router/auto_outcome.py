...
def recent(directory: Path, limit: int = 10) -> list[dict[str, Any]]:
    ...
    for decision in decisions:
        ...
        results.append({
            ...
            "coordinator_model": decision.get("coordinator_model"),
            "coordinator_effort": decision.get("coordinator_effort"),
            "reason": decision.get("reason"),
            "policy_band": decision.get("policy_band"),
            "telemetry_schema": decision.get("telemetry_schema"),
            "session_fingerprint": decision.get("session_fingerprint"),
            "previous_route_key": decision.get("previous_route_key"),
            "relationship": decision.get("relationship"),
            "score": decision.get("score"),
            "compared": decision.get("compared"),
            "profile": decision.get("profile"),
            "routing_source_sha256": decision.get("routing_source_sha256"),
            "guide_source_sha256": decision.get("guide_source_sha256"),
            "usage": usage,
